package com.erp.erp_weather_batch.util;

public final class DfsGridConverter {

    private DfsGridConverter() {}

    // 기상청 DFS 격자 변환 상수(공식 예제에서 널리 쓰는 값)
    ...
    public record XY(int nx, int ny) {}
}